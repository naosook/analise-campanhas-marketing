...
O dashboard consolida visualmente os principais indicadores e resultados da análise exploratória, incluindo um comparativo direto entre investimento médio e ROI médio por canal, que substitui as visualizações de dispersão utilizadas na fase exploratória da análise.
